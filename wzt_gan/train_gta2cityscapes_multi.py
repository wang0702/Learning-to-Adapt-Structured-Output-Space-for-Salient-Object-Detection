...
NUM_STEPS = 250000 #训练步数
NUM_STEPS_STOP = 150000  # early stopping
POWER = 0.9 #？
RANDOM_SEED = 1234 #随机种子
RESTORE_FROM = 'http://vllab.ucmerced.edu/ytsai/CVPR18/DeepLab_resnet_pretrained_init-f81d91e8.pth' #预训练参数
SAVE_NUM_IMAGES = 2 #？
...
def main():
    ...
    if args.model == 'DeepLab':
        # 重要一步 输入类别数
        model = DeeplabMulti(num_classes=args.num_classes) # 生成一个由resnet组成的语义分割模型
        # 读取pretrained模型
